...
nbsimul = 1;%to reproduce the results it needs to be set at 100
do_seasonality = 'n' % 'y' or 'n'
scenario_Song = 'y' % 'y' is Song and 'n' is Goldberg
detrended_Climate = 'y' %'y' adds the detrended climate (at 12PAL constant)
